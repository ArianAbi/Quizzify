  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="text-lg md:text-2xl font-semibold p-4 rounded-md transition-all duration-150 bg-cyan-600 hover:bg-cyan-500 hover:scale-110">
          Play Again
        </button>

        <button className="underline underline-offset-8 italic text-sky-400 text-base md:text-lg">
          go to the menu
        </button>
      </motion.div>
    </motion.div>
